...
/// Mobius code did not, and `-mobius.enabled YES ./.build/debug/PokeTokenBarExtended`
...
final class MobiusBundleGuardTests: XCTestCase {
    ...
    /// `Sources/PokeTokenBarExtended/Mobius/` must sit behind the same gate. The two
    ...
    func testEveryNotificationCenterUseInMobiusSourcesIsGuarded() throws {
        let dir = URL(fileURLWithPath: #filePath)
            ...
            .appendingPathComponent("Sources/PokeTokenBarExtended/Mobius")
