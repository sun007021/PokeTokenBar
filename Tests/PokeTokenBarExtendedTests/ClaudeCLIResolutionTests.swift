...
final class ClaudeCLIResolutionTests: XCTestCase {
    ...
    func testAccountSwitchingResolvesBinariesThroughTheSharedLocator() throws {
        for file in ["Sources/PokeTokenBarExtended/Mobius/ClaudeCLI.swift",
                     "Sources/PokeTokenBarExtended/Mobius/LoginFlow.swift",
                     "Sources/PokeTokenBarExtended/Mobius/ToolInventory.swift"] {
