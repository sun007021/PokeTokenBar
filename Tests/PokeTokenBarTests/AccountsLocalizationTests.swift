...
final class AccountsLocalizationTests: XCTestCase {
    ...
    func testTheHostSeedsAndUpdatesTheLanguageMirror() throws {
        let app = try MobiusTestSupport.sourceLines(of: "Sources/PokeTokenBar/PokeTokenBarApp.swift")
        ...
        let settings = try MobiusTestSupport.sourceLines(of: "Sources/PokeTokenBar/UI/SettingsView.swift")
            .filter { !MobiusTestSupport.isComment($0) }
            .joined(separator: "\n")
